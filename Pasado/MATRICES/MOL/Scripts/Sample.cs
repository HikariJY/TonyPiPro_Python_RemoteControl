...
public class Sample : MonoBehaviour
{
    ...
    {
        double[,] ArrMat = new double[6, 3] {   { 1.0, 4.0, 8.0},
                                                { 3.0, 2.0, 6.0},
                                                { 1.0, 4.0, 8.0},
                                                { 3.0, 2.0, 6.0},
                                            { 3.0, 2.0, 6.0},
                                                { 3.0, 2.0, 6.0}};
        Matrix Mat = new Matrix(ArrMat);
        //Matrix Vec = new Matrix(new double[] { 1.0, 2.0, 3.0, 2.0, 3.0 });
        double[,] A = new double[3, 3]  {       { 1.0, 4.0, 8.0 },
                                                { 3.0, 2.0, 6.0},
                                                { 3.0, 2.0, 6.0}};
        Matrix M = new Matrix(A);
        Matrix Ans = Mat * M;

        Debug.LogFormat("Mat(6, 3) * M(3, 3)  = \n{0}", Ans);
    }
